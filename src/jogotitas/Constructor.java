...
public class Constructor extends personagens {

    public Constructor(int psx, int psy, String direcao) {
        this.px = psx;
        this.py = psy;
            ...
            if("F".equals(vet)){
                if("L".equals(person.getDirecao())){// Se o personagem estiver para o leste
                    if(person.getPy()+1 >= coluna){//Parede
                        ...
                        else if(matriz[person.getPx()][person.getPy() + 1] == '#'){// barreira vira 90
                            person.setDirecao("S");
                        }
                        else if(matriz[person.getPx()][person.getPy() + 1] == '@'){// buraco morre
                            person.setPy(person.getPy() + 1);
                            morto = 1;
                        }
                    ...
                    if(person.getPx() <= 0){//Parede
                        ...
                        else if(matriz[person.getPx()-1][person.getPy()] == '#'){// barreira vira 90
                            person.setDirecao("L");
                        }
                        else if(matriz[person.getPx()-1][person.getPy()] == '@'){// buraco morre
                            person.setPx(person.getPx() - 1);
                            morto = 1;
                        }
                    ...
                    if(person.getPx()+1 == linha){//Parede
                       ...
                       if(matriz[person.getPx()+1][person.getPy()] == '.'){
                        ...
                        else if(matriz[person.getPx()+1][person.getPy()] == '#'){
                            person.setDirecao("O");
                        }
                        else if(matriz[person.getPx()][person.getPy()] == '@'){
                            person.setPx(person.getPx() +1);
                            morto = 1;
                        }
                        else{// Tesouro
